...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/living/transportation-guide"
---
...
- **Top up**: at MTR Add Value Machines, convenience stores, or auto-add via linked bank account
- **Discounts**: using Octopus on buses and trams is slightly cheaper than cash; cross-boundary fares also use Octopus
- **Child/elderly/student cards**: discounted fare categories available
...
- Areas not served by MTR (many hillside residential areas)
- Cross-harbour bus routes (sometimes more direct than MTR cross-harbour)
- Night services (buses run all night; MTR closes ~1am)
...
- **Never drive if you can avoid it**: Parking is scarce and expensive; public transport is faster for most journeys
- **Download the MTR app**: Journey Planner, fare calculator, exit guides all in one
- **The Airport Express**: HK$115 from Hong Kong Station to the airport — fast and reliable, skip the taxi queue
- **Minibus destination signs**: Often in Chinese only — having a local translate your regular destination on day one saves confusion
- **Timing**: Morning peak (8-9:30am) and evening peak (5:30-7:30pm) MTR platforms are very crowded. Give yourself extra time during the first weeks.
