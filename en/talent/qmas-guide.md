...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/talent/qmas-guide.html"
---

# Hong Kong Quality Migrant Admission Scheme (QMAS): A Complete Overview
...
- **Academic qualification:** A good first degree (at minimum) from a recognised university or tertiary institution. ImmD does not publish a definitive list of recognised institutions but assesses credentials based on their international standing.
- **Financial self-sufficiency:** The applicant must demonstrate the financial means to support themselves and any dependants during the initial settlement period without recourse to public funds.
- **No adverse immigration history:** Applicants with prior immigration violations in Hong Kong or elsewhere face heightened scrutiny and may be disqualified.
- **Chinese nationality requirement (APT only):** This is a significant and often overlooked constraint — the APT track is available **only to Chinese nationals (including Hong Kong permanent residents of Chinese descent)**. Non-Chinese nationals cannot apply under APT regardless of their achievements; they must use the GPT track.
...
- **TTPS favours recency and income:** A 28-year-old with a degree from a top-100 university who graduated four years ago qualifies without further scrutiny. A 45-year-old distinguished expert from a non-ranked institution does not, regardless of career accomplishments.
- **QMAS rewards depth of achievement:** A 40-year-old chartered engineer with 15 years of specialised experience, multiple professional qualifications, and bilingual proficiency might score strongly under GPT even without a top-100 degree. QMAS rewards the totality of a professional profile rather than a single qualifying credential.
- **TTPS has an expiry:** It was introduced as a trial with defined review periods. Its continued existence beyond the original pilot window is subject to policy review. QMAS has been a stable part of the immigration landscape since 2006.
...
- **QMAS is Hong Kong's employer-independent talent visa** — competitive, quota-based (~4,000/year), and globally open to professionals seeking to establish Hong Kong residency without a pre-arranged job offer.

- **Two scoring tracks serve different profiles:** GPT rewards the totality of a professional career (age, qualifications, experience, language, family ties); APT rewards internationally distinguished achievement and is restricted to Chinese nationals only.

- **Competition is real.** Meeting the minimum threshold is not sufficient — applications must score competitively against a global applicant pool. The effective qualifying score shifts year to year.

- **QMAS vs TTPS:** TTPS is higher-volume and threshold-based (top-100 university or HKD 2.5M+ income), making it more accessible for recent top-university graduates and high earners. QMAS rewards career depth and is more suitable for mid-career professionals whose distinction lies in accumulated achievement rather than a single qualifying credential.

- **QMAS vs GEP:** If you already have an HK employer, GEP is typically faster. QMAS is the right channel when you want to land in Hong Kong independently and explore your options without being tied to a single employer.

- **The path to permanent residency is real** — seven years of continuous residence as a QMAS holder qualifies an individual for Right of Abode. Dependant spouses may work without restriction from day one.

- **Authoritative source:** All applications and eligibility assessment should reference the current official QMAS guidance published by the Hong Kong Immigration Department at www.immd.gov.hk.
