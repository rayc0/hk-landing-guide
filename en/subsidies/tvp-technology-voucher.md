...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/subsidies/tvp-technology-voucher.html"
---

# Hong Kong Technology Voucher Programme (TVP): Funding Your Business Technology Upgrade
...
- For a project costing **HK$100,000**, the government funds **HK$75,000** and your company contributes **HK$25,000**.
- For a project at the **HK$600,000 ceiling**, the government provides **HK$450,000** and your company covers **HK$150,000**.
...
- **Enterprise Resource Planning (ERP)** — integrated software platforms managing finance, procurement, inventory, HR, and operations
- **Customer Relationship Management (CRM)** — tools for managing customer data, sales pipelines, and service interactions
- **Human Resources Management Systems (HRMS)** — payroll processing, leave management, attendance tracking
- **Accounting and financial management software**

### Retail and Hospitality Technology
- **Point-of-Sale (POS) systems** — hardware, software, and integration costs for modern checkout and order management platforms
- **Inventory management systems** linked to sales channels
- **Online ordering and reservation platforms**

### Cloud and Infrastructure
- **Cloud computing migration** — moving on-premises systems to cloud environments (AWS, Microsoft Azure, Google Cloud, and others)
- **Software-as-a-Service (SaaS) subscriptions** for qualifying platforms
- **Data storage and backup solutions**

### Security and Compliance
- **Cybersecurity solutions** — firewalls, endpoint protection, intrusion detection, vulnerability assessments
- **Data protection and compliance tools**
- **Network security infrastructure upgrades**

### Communication and Collaboration
- **Business communication platforms** — unified communications, video conferencing infrastructure
- **Document management systems**
- **Workflow automation tools**

### E-Commerce and Digital Transformation
- **E-commerce platform development and integration**
- **Digital payment gateway implementation**
...
**1. Registered in Hong Kong**
The applicant must be a business entity registered under Hong Kong law. This includes companies incorporated under the Companies Ordinance, sole proprietorships, and partnerships registered under the Business Registration Ordinance.

**2. Substantive Business Operations in Hong Kong**
This is the more meaningful qualifier. The ITC wants to fund businesses that are genuinely operating in Hong Kong — not shell companies, dormant entities, or businesses whose only Hong Kong presence is a registered address. Applicants need to demonstrate real operational activity: staff, premises, revenues, and business activities conducted within Hong Kong.

**3. Non-Listed Status**
Companies listed on the Hong Kong Stock Exchange, or subsidiaries of listed companies, are not eligible. TVP is specifically targeted at the private SME sector.

**4. Not a Subsidiary of a Listed Company**
Even if the applicant company itself is not listed, it cannot be a subsidiary of a listed entity.

### Who Typically Benefits

In practice, TVP serves an extremely wide range of businesses:

- Retail shops and chains looking to modernise POS and inventory systems
- Restaurants and F&B groups upgrading order management and back-of-house operations
- Trading companies implementing ERP for procurement and logistics
- Professional services firms (accountants, lawyers, consultants) moving to cloud-based practice management software
- Manufacturing SMEs in Hong Kong or with Hong Kong operations
- Import/export businesses integrating digital documentation and customs management tools
- Startups that have moved past the pure development phase and now have genuine operational technology needs
...
Unlike some schemes targeted at specific sectors (manufacturing, logistics, etc.), TVP is open to virtually all non-listed businesses with Hong Kong operations. A restaurant and a law firm and a garment trader can all apply.

**Technology-Agnostic Eligibility**
TVP doesn't require you to use a government-approved vendor list. As long as the technology solution fits within an eligible category and can be justified as improving productivity or operations, you have real vendor choice.

**Phased Applications**
Because the HK$600,000 ceiling is cumulative across multiple applications, businesses can structure their technology adoption in phases — applying for a POS upgrade this year and an ERP implementation next year, rather than having to plan and execute everything at once.

**Relatively Streamlined Process**
Compared with more complex schemes like BUD Fund, TVP has a more straightforward application process. The ITC has also published clear guidelines on eligible costs and what constitutes a qualifying project, reducing ambiguity.

**Established Track Record**
TVP has been running since 2016. The ITC and service providers in the market are familiar with the programme's requirements, making it easier to find vendors who understand how to scope and document projects in ways that meet programme criteria.
...
- **Software licences and subscriptions** (including SaaS fees for the project period)
- **Hardware costs** where hardware is integral to the technology solution (e.g., POS terminals, network equipment for cybersecurity implementation)
- **Customisation and development costs** for adapting standard software to business requirements
- **Data migration** costs
- **Implementation and integration services** from vendors
- **Staff training** directly related to the new system
- **Consultancy fees** for project scoping and management, within limits
...
- **TVP is administered by Hong Kong's Innovation and Technology Commission (ITC)** and funds technology adoption by non-listed enterprises with substantive Hong Kong business operations.

- **Maximum government contribution is HK$600,000 per enterprise**, on a cumulative basis across all TVP applications.

- **The co-funding ratio is 3:1**: the government pays 75% of eligible project costs; your company pays 25%.

- **Eligible technologies are broad**: ERP, POS, CRM, cloud computing, cybersecurity, data analytics, e-commerce platforms, and more — the key requirement is that the solution improves business productivity or operational efficiency.

- **Eligibility is wide**: any non-listed business registered in Hong Kong with substantive local operations can apply, regardless of industry.

- **Multiple phased applications are possible**: the HK$600,000 ceiling is cumulative, not per-project, allowing businesses to plan staged technology upgrades.

- **TVP is one of the most accessible HK government subsidies**: compared with BUD Fund (more complex, broader scope) or ITF Enterprise Support Scheme (higher bar, R&D focus), TVP has lower administrative overhead and fewer eligibility hurdles for straightforward technology adoption projects.

- **Common use cases** include restaurant POS upgrades, ERP implementations for trading companies, cloud migrations, and cybersecurity rollouts for professional services firms.

- **Eligible costs** include software licences, hardware integral to the solution, implementation services, data migration, and staff training — but not pre-purchase costs or general IT maintenance unrelated to the project.
