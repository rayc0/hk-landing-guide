...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/subsidies/innovation-guiding-fund.html"
---
...
- Promote research and development (R&D) activities in Hong Kong
- Encourage applied research that benefits industry
- Facilitate technology transfer between academia and business
- Strengthen Hong Kong's position as a regional innovation hub
- Support cross-boundary technology cooperation, particularly within the Guangdong-Hong Kong-Macao Greater Bay Area (GBA)
...
- Open to companies of all sizes, from startups to large corporates
- Projects must be genuinely R&D in nature — not routine product development, quality testing, or IT deployment
- A matching requirement applies: the applicant company must contribute at least half of the total project cost from its own resources
- The ITF's contribution under ESS is capped at **HK$10 million per project** (though in practice most approved projects receive between HK$500,000 and HK$4 million)
- Projects typically run for 12 to 36 months
- Companies may hold multiple active ESS projects simultaneously, subject to overall portfolio scrutiny
...
- **Tier 1 (Platform Projects):** Long-term thematic research platforms, typically funded at HK$1–5 million per year for three to five years. These establish research capacity in strategic areas such as artificial intelligence, robotics, or biotechnology.
- **Tier 2 (Project-based):** Discrete applied research projects with a defined output. Funding is typically HK$200,000 to HK$2 million per project.
...
- Both the Hong Kong and Guangdong sides must be legitimate entities in their respective jurisdictions
- The Hong Kong participant applies through the ITC; the Guangdong participant applies to the Guangdong Science and Technology Department in parallel
- Dual approval is required before funding is confirmed — if one side is rejected, the project does not proceed
- Maximum funding from the Hong Kong side: **HK$6 million per project**
- Projects must have clear benefits to both Hong Kong and Guangdong; purely Hong Kong-focused outputs are not sufficient
...
- The university or research institute is the lead applicant, not the company
- The company is an industry partner, not the grant holder
- The company must provide **at least one-third** of the total project cost in cash (not in-kind)
- Funding from the ITF side can reach **HK$10 million**, and projects can run up to three years
...
- Maximum cumulative funding: **HK$600,000 per enterprise** (as of the most recent programme update; this has been raised multiple times since TVP's 2016 launch)
- Government contribution: **75% of approved project costs**, with the SME contributing the remaining 25%
- Projects can be split across multiple vouchers; the current structure allows up to six approved projects
- Service providers must be on the ITC's approved list — using an unapproved vendor disqualifies the expenditure
...
For a detailed breakdown of TVP including eligibility criteria, approved service categories, and programme mechanics, see the dedicated [TVP guide](/en/subsidies/tvp-technology-voucher.md) in this series.
...
- Government contribution: **one-third** of the approved project cost
- Maximum government contribution: **HK$15 million per project**
- Applicants must be incorporated in Hong Kong and must demonstrate that the production line will be physically located in Hong Kong
- The production process must incorporate a meaningful degree of novel technology — not simply relocating an existing line from Mainland China
...
- **InnoHK Research Clusters**: State-level R&D platforms established at the Hong Kong Science and Technology Parks and Cyberport, funded separately but aligned with ITF objectives
- **Hong Kong Science and Technology Parks (HKSTP)**: Provides physical incubation, co-working, and pilot facility space; many HKSTP tenants also hold ITF grants
- **Cyberport**: The government's digital technology hub; ICT-focused companies here frequently participate in TVP and ESS
- **Research Grants Council (RGC)**: Funds basic and applied research at universities; RGC projects sometimes feed into later ITF commercialisation-stage applications
- **HKRITA**: The Hong Kong Research Institute of Textiles and Apparel manages certain ITF grants relevant to the textile and fashion technology sector
...
- The ITF is an umbrella of funding programmes, not a single grant, and is managed by the Innovation and Technology Commission.
- **ESS** is the primary route for private companies conducting genuine R&D in Hong Kong; it requires a 50% company match and offers up to HK$10 million per project.
- **ITSP** funds applied research at universities and public research institutes; companies participate as industry partners rather than lead applicants.
- **TCFS** requires a Guangdong co-applicant and dual approval from both Hong Kong and Guangdong authorities; maximum ITF contribution is HK$6 million from the Hong Kong side.
- **PRP** facilitates deeper university-industry collaboration, with universities as grant holders and companies contributing at least one-third of project costs in cash.
- **TVP**, while part of the ITF family, serves a different purpose — it funds technology *adoption* by SMEs, not R&D, with a maximum cumulative grant of HK$600,000 and a 75% government contribution.
- **RFS** supports smart manufacturing facility establishment in Hong Kong, with the government covering up to one-third of costs up to HK$15 million.
- Organisations can hold concurrent grants across different ITF programmes if they meet each programme's criteria.
- The ITF operates within a broader innovation ecosystem that includes HKSTP, Cyberport, InnoHK clusters, and the RGC; the right funding source depends on the stage and nature of the activity.
- GBA alignment is increasingly relevant to how applications are framed and assessed, particularly for cross-boundary or Mainland-facing projects.
