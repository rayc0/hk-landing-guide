...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/company/ip-protection.html"
---
...
1. **Hold registered IP** (trademarks, patents) for Asia-Pacific markets
2. **License that IP** to operating subsidiaries in mainland China, Southeast Asia, and elsewhere — generating royalty income taxed at Hong Kong's low profits tax rate (currently 16.5%, with a two-tier rate of 8.25% on the first HKD 2 million)
3. **Use the IP as a balance sheet asset** for financing — Hong Kong banks are experienced in IP-backed lending
4. **Benefit from treaty protection** — Hong Kong's network of double taxation agreements (DTAs) with 45+ jurisdictions often provides reduced withholding tax on royalty payments
...
*Published under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). Source: [hkguide.org](https://hkguide.org)*
