...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/company/company-formation"
---

# Setting Up a Company in Hong Kong: Limited Company, Branch Office and Business Registration
...
- **Shareholders:** Minimum one, maximum 50. Shareholders can be individuals or corporate entities of any nationality. There is no requirement for a Hong Kong resident shareholder.
- **Directors:** Minimum one individual director. Corporate directors are permitted alongside individual directors, but at least one director must be a natural person. Directors can be of any nationality and need not reside in Hong Kong.
- **Company Secretary:** Every Hong Kong company must have a company secretary. If the secretary is an individual, they must ordinarily reside in Hong Kong. If a corporate body, it must have a registered office in Hong Kong. The same person cannot be the sole director and sole company secretary simultaneously. In practice, most businesses appoint a professional company secretarial firm to fulfil this role.
- **Registered Address:** A Hong Kong address is required as the company's registered office. This must be a physical address (not a PO Box) to which official mail from the Companies Registry and Inland Revenue Department can be delivered.
- **Share Capital:** There is no minimum share capital requirement. One ordinary share of HKD 1 is legally sufficient. Most incorporations use 10,000 ordinary shares at HKD 1 each as a clean round number, though the amount has no practical bearing on the company's ability to do business.
...
- Companies Registry incorporation fee: HKD 1,720 (standard)
- Business Registration Certificate: HKD 2,150 per year, or HKD 5,950 for three years (current rates; subject to change annually in the Budget)
...
- **Annual Return (Form NAR1):** Filed with the Companies Registry within 42 days of the incorporation anniversary each year. Current government fee: HKD 105 for an e-filing, HKD 140 for paper. This updates the public register with current director, shareholder and address information.
- **Business Registration Renewal:** Annual or triennial, as chosen at incorporation.
- **Audited Financial Statements:** All Hong Kong companies must prepare audited accounts annually. Small private companies meeting two of three size tests (turnover ≤ HKD 100 million, total assets ≤ HKD 100 million, employees ≤ 100) qualify for simplified reporting but still require an audit by a CPA registered in Hong Kong.
- **Profits Tax Return:** Filed with the IRD, typically 18 months after incorporation for the first return and annually thereafter. Hong Kong has no capital gains tax, no dividends tax, no sales tax and no estate duty.
- **Significant Controllers Register (SCR):** Companies must maintain an up-to-date register of significant controllers (beneficial owners holding ≥ 25%) and make it accessible to law enforcement. This is an internal register, not publicly filed.
