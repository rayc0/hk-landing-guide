...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/company/register-hk-company.html"
---

# Why Hong Kong Is Still the Best Place to Register Your Company
...
- **16.5%** on all profits above HK$2,000,000
...
## The Legal Framework: Companies Ordinance (Cap. 622)
...
- **Limited liability**: shareholders' personal liability is limited to the amount unpaid on their shares
- **Legal personality**: the company is a distinct legal entity from its shareholders and directors
- **Separate ownership and management**: shares can be held by one person while the company is managed by another
- **Restriction on share transfer**: the Articles must contain restrictions on the transfer of shares, which is what distinguishes a "private" company from a public one
- **Maximum 50 shareholders** (excluding employees and former employees who hold shares)
...
- A **Hong Kong resident individual** (ordinarily resident in Hong Kong), or
...
- Hong Kong's **territorial basis of taxation** means offshore-sourced profits are not subject to Profits Tax — a structural advantage unavailable in most jurisdictions.
- For profits taxed in Hong Kong, the **two-tier rate** (8.25% on the first HK$2M, 16.5% above) is among the lowest in the developed world.
- The **Companies Ordinance (Cap. 622)** governs incorporation; the **Companies Registry** administers it; every operating company also needs a **Business Registration Certificate** from the Inland Revenue Department.
- The **private company limited by shares** is the correct structure for nearly all entrepreneurial and SME purposes.
- Structural requirements are practical and flexible: at least one natural-person director (any nationality), a Hong Kong-resident company secretary or HK-incorporated corporate secretary, a Hong Kong registered address, and no minimum paid-up capital.
- Every Hong Kong company must file an **Annual Return**, maintain **audited financial statements** prepared by a Hong Kong CPA, and file a **Profits Tax Return** — annual compliance costs are real and should be budgeted.
- Compared to Singapore and BVI, Hong Kong offers the most complete package for businesses with any China dimension: direct market access via CEPA, credible common law legal standing, no FX controls, and a mature banking infrastructure.
- **Banking is the most significant practical challenge** for new incorporations; prospective owners should research bank requirements and prepare documentation carefully before relying on a Hong Kong entity for live operations.
