...
license: "CC BY 4.0"
canonical: "https://hkguide.org/en/company/hk-tax-advantages.html"
---

# Hong Kong Tax Advantages: A Complete Guide to the Territorial Tax System
...
- Negotiations with customers and suppliers conducted outside Hong Kong
- Visits to overseas factories, warehouses, and customers conducted by staff based outside Hong Kong
- Contracts signed outside Hong Kong
- Goods physically never entering or passing through Hong Kong
- Business decisions made outside Hong Kong

**What undermines an offshore claim:**
- All staff and management located in Hong Kong
- Substantive business activities (order processing, customer management) happening in Hong Kong offices
- Inconsistency between the claimed offshore nature of operations and the actual day-to-day substance
...
- **Territorial taxation is the foundation.** Hong Kong taxes only profits arising in or derived from Hong Kong. Genuinely offshore profits are outside the tax net — not by exemption, but by structural design.

- **The two-tier profits tax rate** of 8.25% (first HK$2M) and 16.5% (thereafter) is competitive globally, especially for growing businesses where the blended effective rate falls well below the headline 16.5%.

- **No capital gains tax** makes Hong Kong structurally attractive for investment holding, exit planning, and IP disposal.

- **No VAT/GST** eliminates an entire layer of compliance and indirect tax cost that burdens businesses in most major economies.

- **No withholding tax on dividends** allows full profit repatriation to overseas shareholders without erosion at source.

- **No estate duty** facilitates intergenerational business transfer without tax friction.

- **Salaries tax caps at 15%** (standard rate), making Hong Kong competitive for attracting and retaining executive talent.

- **The CDTA network** (45+ agreements) reduces withholding taxes on cross-border income flows and provides treaty protection for internationally active businesses.

- **Three primary structures** — trading company, IP holding, and regional HQ — have proven track records of using Hong Kong's tax framework efficiently and legitimately.

- **The offshore claim** is a factual determination based on where activities genuinely occur. It is a feature of territorial taxation, not a workaround.

- **Pillar Two** applies only to large multinationals above EUR 750 million in global revenues. The vast majority of businesses are unaffected.
